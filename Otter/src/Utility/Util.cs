...
using FNAVector4 = Microsoft.Xna.Framework.Vector4;
...
namespace Otter {
    ...
    public static class Util {
        ...
        */
        ...
        public static bool PointInRect(Vector2 p, Vector2 min, Vector2 max) {
        ...
        /// <returns>True if the point is in the rectangle.</returns>
        public static bool PointInRect(float x, float y, Rectangle rect) {
        ...
        /// <param name="rect">The rectangle.</param>
        /// <returns>True if the point is in the rectangle.</returns>
        public static bool PointInRect(Vector2 xy, Rectangle rect) {
            return PointInRect((float)xy.X, (float)xy.Y, rect);
        }
        ...
        public static bool PointInCircle(Vector2 p, Vector2 circleP, float radius) {
        ...
        /// <param name="radius">The radius of the circle.</param>
        /// <returns>True if the point is inside the circle.</returns>
        public static bool PointInCircle(float x, float y, float circleX, float circleY, float radius) {
        ...
        public static bool RectInRect(float x1, float y1, float w1, float h1, float x2, float y2, float w2, float h2) {
        ...
        public static float DistancePointRect(float px, float py, float rx, float ry, float rw, float rh) {
            if (px >= rx && px <= rx + rw) {
        ...
        /// <param name="rect">The rectangle.</param>
        /// <returns>The distance.  Returns 0 if the point is within the rectangle.</returns>
        public static float DistancePointRect(float px, float py, Rectangle rect) {
            return DistancePointRect(px, py, rect.X, rect.Y, rect.Width, rect.Height);
        }
        ...
        public static bool Approx(this float x, float y) {
            return x >= y - float.Epsilon && x <= y + float.Epsilon;
        }
